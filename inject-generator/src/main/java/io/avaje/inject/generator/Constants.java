...
final class Constants {
  ...
  static final String AT_SUPPRESS_WARNINGS = "@SuppressWarnings(\"all\")";
  ...
  static final String META_INF_NATIVE_IMAGE = "META-INF/native-image/avaje-inject/reflect-config.json";
